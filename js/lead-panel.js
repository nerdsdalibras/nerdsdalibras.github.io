  ...
  if (tab === 'dados') {
    ...
    body.innerHTML = `
      ...
      <div class="panel-section">
        ...
        ${l.campanhaAbriuEm ? `<div class="panel-field"><span class="pf-label">Abriu campanha</span><span class="pf-val" style="color:var(--g)">👀 ${new Date(l.campanhaAbriuEm).toLocaleString('pt-BR')}</span></div>` : ''}
        ${l.campanhaClicouEm ? `<div class="panel-field"><span class="pf-label">Clicou no link</span><span class="pf-val" style="color:var(--blue)">🖱 ${new Date(l.campanhaClicouEm).toLocaleString('pt-BR')}</span></div>` : ''}
